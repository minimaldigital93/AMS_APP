                                    ...
                                    <li class="flex items-center gap-3 px-5 py-3 hover:bg-slate-50/70 transition">
                                        ...
                                        @if($isAvailable)
                                            <a href="{{ route('supervisor.tenants.create', ['apartment_id' => $apt['id']]) }}"
                                               ...
                                               class="shrink-0 inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium text-emerald-700 bg-emerald-50 hover:bg-emerald-100 transition">
