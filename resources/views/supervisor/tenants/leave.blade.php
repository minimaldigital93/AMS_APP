...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6" x-data="leaveForm()">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('supervisor.tenants.index') }}" class="inline-flex items-center px-4 py-2 bg-slate-800 text-white rounded-lg hover:bg-slate-700 transition" title="{{ __('messages.back_to_tenants') }}">
    ...
    <!-- Leave Form -->
    <form id="leaveForm" action="{{ route('supervisor.tenants.processLeave', $tenant) }}" method="POST">
        @csrf
