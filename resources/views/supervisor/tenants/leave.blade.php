...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6" x-data="leaveForm()">
    ...
    <form id="leaveForm" action="{{ route('supervisor.tenants.processLeave', $tenant) }}" method="POST">
        ...
        <div class="flex gap-3 mt-4">
            ...
            <a href="{{ route('supervisor.tenants.index') }}" class="flex-1 px-5 py-2.5 border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition text-center text-sm">
                Cancel
            </a>
        </div>
    </form>
