            ...
            <div class="bg-white rounded-xl border border-slate-100 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-slate-800">{{ $tenants->total() }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl border border-slate-100 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-slate-500 text-sm">Apartments</p>
                        <p class="text-2xl font-bold text-slate-800">{{ $apartments->count() }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl border border-slate-100 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-slate-500 text-sm">Rent Income</p>
                        <p class="text-2xl font-bold text-slate-800">${{ number_format($incomeStats['total_rent_collected'] ?? 0, 2) }}</p>
                    </div>
                </div>
            </div>
        </div>
