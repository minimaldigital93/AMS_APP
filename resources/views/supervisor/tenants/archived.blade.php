        ...
        <div class="bg-white rounded-xl border border-slate-100 mb-6 p-6">
            <form method="GET" action="{{ route('supervisor.tenants.archived') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end justify-center md:col-span-1">
                    <a href="{{ route('supervisor.tenants.archived') }}" class="inline-flex items-center h-10 px-3 whitespace-nowrap border border-slate-200 rounded-md text-slate-700 hover:bg-slate-50 transition font-medium text-center text-sm" title="{{ __('messages.reset') }}">
