...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <!-- Settings Form -->
        <form method="POST" action="{{ route('supervisor.settings.updateBatch') }}" class="space-y-6">
            @csrf
            @method('PUT')
...
<form id="resetForm" method="POST" action="{{ route('supervisor.settings.reset') }}" style="display: none;">
    @csrf
    @method('DELETE')
</form>
