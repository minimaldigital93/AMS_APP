...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <form method="GET" action="{{ route('supervisor.revenue_expense.income_statement') }}">
    ...
    <div class="mb-6 flex items-center justify-center">
        <div class="inline-flex items-center bg-white rounded-xl shadow border border-gray-200 px-2 py-1.5 gap-1">
            @if($prevMonth)
            <a href="{{ route('supervisor.revenue_expense.income_statement', ['period' => $activePeriod->id, 'month' => $prevMonth['month'], 'year' => $prevMonth['year']]) }}"
            ...
            @if($nextMonth)
            <a href="{{ route('supervisor.revenue_expense.income_statement', ['period' => $activePeriod->id, 'month' => $nextMonth['month'], 'year' => $nextMonth['year']]) }}"
               class="inline-flex items-center justify-center w-10 h-10 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-blue-600 transition">
            ...
            {{-- View All link --}}
            @if($filterMonth)
            <a href="{{ route('supervisor.revenue_expense.income_statement', ['period' => $activePeriod->id]) }}"
    ...
    <div class="mb-6 flex flex-wrap justify-center gap-1">
        @foreach($periodMonths as $pm)
            ...
            @endphp
            <a href="{{ route('supervisor.revenue_expense.income_statement', ['period' => $activePeriod->id, 'month' => $pm['month'], 'year' => $pm['year']]) }}"
