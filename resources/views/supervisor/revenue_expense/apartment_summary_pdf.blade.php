...
<body>
    ...
    <div style="margin-bottom:12px; display:flex; gap:8px; align-items:center;">
        ...
        <a href="{{ route('supervisor.revenue_expense.apartment_summary_pdf', ['start' => $start, 'end' => $end, 'summary_only' => $summaryOnly ?? false, 'whole' => $wholeNumbers ?? false]) }}" target="_blank" style="padding:8px 12px; background:#2563eb; color:#fff; border-radius:6px; text-decoration:none;">{{ __('messages.download_pdf') }}</a>
