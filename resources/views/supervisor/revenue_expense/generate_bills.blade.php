        ...
        <div class="space-y-4 mb-8">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden {{ $bill['has_unbilled'] ? '' : 'opacity-60' }}">
                ...
                <div class="p-4">
                    ...
                    @else
                    <p class="text-sm text-gray-400 text-center py-2">No fixed expenses assigned. <a href="{{ route('supervisor.revenue_expense.fixed_expenses') }}" class="text-blue-600 underline">Add some</a></p>
                    @endif
                </div>
            </div>
            @endforeach
