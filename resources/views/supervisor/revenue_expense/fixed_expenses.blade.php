            ...
            <div class="bg-white rounded-lg shadow-md p-6 mt-6">
                ...
                <div class="space-y-3 text-sm text-gray-600">
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <p>{{ __('messages.how_step3_pre') }} <a href="{{ route('supervisor.revenue_expense.generate_bills') }}" class="text-blue-600 underline">{{ __('messages.generate_monthly_bills') }}</a> {{ __('messages.how_step3_post') }}</p>
                    </div>
                    <div class="flex items-start gap-2">
