            ...
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <form action="{{ route('supervisor.revenue_expense.delete_other_expense', $oe) }}" method="POST" data-confirm="{{ __('messages.remove_expense_confirm') }}">
                                @csrf @method('DELETE')
                    ...
                    <tr class="hover:bg-slate-50/50">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                @endforeach
                                <form action="{{ route('supervisor.revenue_expense.delete_business_expense', $be) }}" method="POST" data-confirm="{{ __('messages.remove_expense_confirm') }}">
                                    @csrf @method('DELETE')
        ...
        <div class="md:hidden divide-y divide-slate-50">
            ...
            @php
                $bizJson = [
                    ...
                    'recurring'  => false,
                    'attachments' => [],
                    'delete_url' => route('supervisor.revenue_expense.delete_other_expense', $oe),
                ];
            @endphp
            <div class="flex items-center gap-3 px-4 py-3 active:bg-slate-50 transition">
                <div class="min-w-0 flex-1">
            ...
            @php
                $bizJson = [
                    ...
                    'attachments' => $be->attachments->map(fn ($a) => [
                        ...
                        'delete_url' => route('supervisor.revenue_expense.delete_business_expense_attachment', [$be, $a]),
                    ])->all(),
                    'delete_url' => route('supervisor.revenue_expense.delete_business_expense', $be),
                ];
            @endphp
            <div class="flex items-center gap-3 px-4 py-3 active:bg-slate-50 transition">
                <div class="min-w-0 flex-1">
