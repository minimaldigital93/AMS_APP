...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    @if($summary['floors'] === 0)
        <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center">
            <p class="text-yellow-800 font-medium">No floors created yet.</p>
            <a href="{{ route('admin.floors.create') }}" class="inline-block mt-3 bg-yellow-600 text-white px-5 py-2 rounded-lg hover:bg-yellow-700 transition text-sm font-medium">Create a Floor</a>
        </div>
    @else
