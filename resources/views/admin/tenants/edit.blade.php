        ...
        <div class="bg-white rounded-xl border border-slate-100 p-6">
            <form action="{{ route('admin.tenants.update', $tenant->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6"
                ...
                <div class="flex gap-3 pt-6">
                    ...
                    <button type="submit" class="flex-1 px-6 py-2 border border-transparent text-base font-medium rounded-md text-white bg-slate-800 hover:bg-slate-700 transition">{{ __('messages.update') }}</button>
                </div>
            </form>
        </div>
