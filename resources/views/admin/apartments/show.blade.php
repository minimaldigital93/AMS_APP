...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            @else text-slate-500 bg-slate-50
            @endif">
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('admin.tenants.leave', $activeRental->tenant) }}" class="inline-flex items-center gap-2 text-red-500 hover:text-red-600 text-sm font-medium py-2.5 px-5 rounded-lg border border-red-200 hover:border-red-300 transition">
            Process Leave
        </a>
        @endif
    </div>
