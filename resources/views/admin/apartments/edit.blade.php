...
<div class="max-w-3xl mx-auto space-y-8">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-slate-800 tracking-tight">Edit Apartment</h1>
    ...
    <div class="bg-white rounded-xl border border-slate-100">
        <form method="POST" action="{{ route('admin.apartments.update', $apartment->id) }}">
            ...
            <div class="p-6 space-y-5">
                <h3 class="text-sm font-medium text-slate-500 uppercase tracking-wide">Apartment Details</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- Apartment Number -->
                    <div>
                        <label class="block text-xs font-medium text-slate-500 mb-1.5 uppercase tracking-wide">Apartment Number <span class="text-red-400">*</span></label>
                        <input type="text" name="apartment_number" value="{{ old('apartment_number', $apartment->apartment_number) }}" required
                               placeholder="e.g., A101, 102"
                    ...
                    <!-- Floor -->
                    <div>
                        <label class="block text-xs font-medium text-slate-500 mb-1.5 uppercase tracking-wide">Floor <span class="text-red-400">*</span></label>
                    ...
                    <!-- Monthly Rent -->
                    <div>
                        <label class="block text-xs font-medium text-slate-500 mb-1.5 uppercase tracking-wide">Monthly Rent <span class="text-red-400">*</span></label>
                    ...
                    <!-- Status -->
                    <div>
                        <label class="block text-xs font-medium text-slate-500 mb-1.5 uppercase tracking-wide">Status <span class="text-red-400">*</span></label>
                    ...
                    <!-- Supervisor -->
                    <div>
                        <label class="block text-xs font-medium text-slate-500 mb-1.5 uppercase tracking-wide">Supervisor</label>
        ...
        <div class="px-6 py-5 border-t border-slate-100">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-sm font-medium text-red-600">Delete Apartment</h3>
                    <p class="text-slate-400 text-xs mt-0.5">This action cannot be undone</p>
                </div>
                <form method="POST" action="{{ route('admin.apartments.destroy', $apartment->id) }}" class="inline" onsubmit="return confirm('Are you absolutely sure you want to delete this apartment?');">
                    @csrf
                    @method('DELETE')
