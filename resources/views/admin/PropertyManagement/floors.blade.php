        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-blue-800">
                    Create floors and quickly assign unit numbers with a default price. Later, you can <strong>edit individual unit names and prices</strong> in Apartment Management.
                </p>
            </div>
        </div>
    </div>
