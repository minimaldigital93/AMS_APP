...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="{{ route('admin.revenue_expense.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition" title="{{ __('messages.back') }}">
                            ...
                            <tr class="{{ $expense->is_active ? '' : 'opacity-50' }}">
                                ...
                                <td class="px-3 py-2 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <form action="{{ route('admin.revenue_expense.delete_fixed_expense', $expense) }}" method="POST" class="inline" data-confirm="{{ __('messages.remove_apt_cost_confirm') }}">
                                            @csrf
                                            @method('DELETE')
