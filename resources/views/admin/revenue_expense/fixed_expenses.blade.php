                            ...
                            <tr class="{{ $expense->is_active ? '' : 'opacity-50' }}">
                                ...
                                <td class="px-3 py-2 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <form action="{{ route('admin.revenue_expense.delete_fixed_expense', $expense) }}" method="POST" class="inline" onsubmit="return confirm('Remove this apartment cost?')">
                                            @csrf
                                            @method('DELETE')
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mt-6">
                ...
                <div class="space-y-3 text-sm text-gray-600">
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <p>Go to <a href="{{ route('admin.revenue_expense.generate_bills') }}" class="text-blue-600 underline">Generate Monthly Bills</a> to auto-create expenses for all tenants</p>
                    </div>
                    <div class="flex items-start gap-2">
