...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <div class="flex gap-3">
            <a href="{{ route('admin.revenue_expense.fixed_expenses') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition text-sm" title="{{ __('messages.manage_apartment_costs') }}">
            ...
            <a href="{{ route('admin.revenue_expense.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition text-sm" title="{{ __('messages.back') }}">
        ...
        <div class="space-y-4 mb-8">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden {{ $bill['has_unbilled'] ? '' : 'opacity-60' }}">
                ...
                <div class="p-4">
                    ...
                    @else
                    <p class="text-sm text-gray-400 text-center py-2">{{ __('messages.no_apt_costs_assigned') }} <a href="{{ route('admin.revenue_expense.fixed_expenses') }}" class="text-blue-600 underline">{{ __('messages.add_some') }}</a></p>
                    @endif
                </div>
            </div>
            @endforeach
