                ...
                <form action="{{ route('admin.revenue_expense.store_business_expense') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-4 flex justify-end">
                        ...
                        <button type="submit" class="inline-flex items-center px-5 py-2.5 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition font-medium text-sm">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg>{{ __('messages.add_business_expense') }}</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <form action="{{ route('admin.revenue_expense.delete_other_expense', $oe) }}" method="POST" onsubmit="return confirm('{{ __('messages.remove_expense_confirm') }}')">
                                @csrf @method('DELETE')
                    ...
                    <tr class="hover:bg-slate-50/50">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                @endif
                                <form action="{{ route('admin.revenue_expense.delete_business_expense', $be) }}" method="POST" onsubmit="return confirm('{{ __('messages.remove_expense_confirm') }}')">
                                    @csrf @method('DELETE')
