...
<div class="max-w-7xl mx-auto px-4 py-6 space-y-5">
    ...
    <div class="flex justify-center">
        <div class="inline-flex items-center bg-white rounded-xl border border-slate-100 px-2 py-1.5 gap-1">
            <a href="{{ route('admin.revenue_expense.monthly_calendar', ['month' => $prevMonth->month, 'year' => $prevMonth->year]) }}"
            ...
            <a href="{{ route('admin.revenue_expense.monthly_calendar', ['month' => $nextMonth->month, 'year' => $nextMonth->year]) }}"
