...
<div class="min-h-screen bg-gray-50 py-8">
    ...
    <!-- Header -->
        ...
        <div>
            <h1 class="text-2xl font-semibold text-slate-800 tracking-tight">{{ __('messages.settings_title') }}</h1>
        </div>
    ...
    <form method="POST" action="{{ route('admin.settings.updateBatch') }}" class="space-y-6">
        ...
        <div class="flex justify-end">
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-lg transition duration-200 flex items-center gap-2" title="{{ __('messages.save_all_settings') }}">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
