    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <span @class([
                ...
                'text-emerald-600 bg-emerald-50' => $displayStatus === 'available',
                'text-sky-600 bg-sky-50' => $displayStatus === 'occupied',
                'text-slate-500 bg-slate-50' => !in_array($displayStatus, ['available', 'occupied']),
            ])>
            <span @class([
                'w-1.5 h-1.5 rounded-full',
                'bg-emerald-400' => $displayStatus === 'available',
                'bg-sky-400' => $displayStatus === 'occupied',
                'bg-slate-400' => $displayStatus === 'maintenance',
                'bg-slate-300' => !in_array($displayStatus, ['available', 'occupied', 'maintenance']),
            ])></span>
