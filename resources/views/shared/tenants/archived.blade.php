...
<div x-data="{ searchOpen: {{ request('search') ? 'true' : 'false' }} }" class="max-w-6xl mx-auto space-y-8">
        ...
        <div class="flex items-center justify-between gap-4">
            ...
            <form method="GET" action="{{ route($panel.'.tenants.archived') }}" class="relative flex items-center">
                ...
                <div x-show="searchOpen" x-transition.opacity x-cloak class="relative">
                    ...
                    <a href="{{ route($panel.'.tenants.archived', request('floor') ? ['floor' => request('floor')] : []) }}" class="absolute right-2.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600">
