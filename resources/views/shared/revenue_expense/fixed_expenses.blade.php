...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="{{ route($panel.'.revenue_expense.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition" title="{{ __('messages.back') }}">
                            ...
                            <tr class="{{ $expense->is_active ? '' : 'opacity-50' }}">
                                ...
                                <td class="px-3 py-2 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <form action="{{ route($panel.'.revenue_expense.delete_fixed_expense', $expense) }}" method="POST" class="inline" data-confirm="{{ __('messages.remove_apt_cost_confirm') }}">
                                            @csrf
                                            @method('DELETE')
            ...
            <div class="bg-white rounded-lg shadow-md p-6 sticky top-8">
                ...
                <form action="{{ route($panel.'.revenue_expense.store_fixed_expense') }}" method="POST">
                    ...
                    <div class="space-y-4">
                        ...
                        <button type="submit" class="w-full inline-flex items-center justify-center px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-medium" title="{{ __('messages.assign_apartment_cost') }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg></button>
                    </div>
                </form>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mt-6">
                ...
                <div class="space-y-3 text-sm text-gray-600">
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <p>{{ __('messages.how_step3_pre') }} <a href="{{ route($panel.'.revenue_expense.generate_bills') }}" class="text-blue-600 underline">{{ __('messages.generate_monthly_bills') }}</a> {{ __('messages.how_step3_post') }}</p>
                    </div>
                    <div class="flex items-start gap-2">
