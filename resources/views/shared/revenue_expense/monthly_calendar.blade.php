...
<div class="max-w-7xl mx-auto px-4 py-6 space-y-5">
    ...
    <div class="flex items-center justify-between gap-4">
        ...
        <a href="{{ route($panel.'.revenue_expense.index') }}"
    ...
    <div class="flex justify-center">
        <div class="inline-flex max-w-full items-center bg-white rounded-xl border border-slate-100 px-1.5 sm:px-2 py-1.5 gap-0.5 sm:gap-1">
            <a href="{{ route($panel.'.revenue_expense.monthly_calendar', ['month' => $prevMonth->month, 'year' => $prevMonth->year]) }}"
            ...
            <div class="px-2 sm:px-4 py-2 min-w-0 sm:min-w-[180px] text-center">
                <span class="text-base sm:text-lg font-bold text-slate-800 whitespace-nowrap">{{ $startOfMonth->format('F') }}</span>
                <span class="text-base sm:text-lg text-slate-400 ml-1">{{ $startOfMonth->format('Y') }}</span>
                @if(!$isCurrentMonth)
                    @if($isFutureMonth)
            ...
            <a href="{{ route($panel.'.revenue_expense.monthly_calendar', ['month' => $nextMonth->month, 'year' => $nextMonth->year]) }}"
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        <div class="bg-white rounded-xl border border-slate-100 p-4 sm:p-5 summary-card" data-card="revenue">
        ...
        <div class="bg-white rounded-xl border border-slate-100 p-4 sm:p-5 summary-card" data-card="expenses">
            <div class="flex items-center gap-3">
        ...
        <div class="bg-white rounded-xl border border-slate-100 p-4 sm:p-5 summary-card" data-card="netprofit">
            <div class="flex items-center gap-3">
        ...
        <div class="bg-white rounded-xl border border-slate-100 p-4 sm:p-5 summary-card" data-card="occupancy">
            <div class="flex items-center gap-3">
