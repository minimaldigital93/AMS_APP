...
<head>
    ...
    <title>@yield('title', __('messages.supervisor_dashboard_title'))</title>
...
<body class="ams-themed flex flex-col h-screen" x-data="sidebarState()" x-init="init()">
        ...
        <aside
            ...
            <div class="bg-white shadow-lg h-full flex flex-col overflow-y-auto">
                ...
                <div class="p-4 border-b border-gray-200 flex items-center justify-between">
                    <h2 class="font-bold text-xl text-emerald-700 sidebar-label" :class="{'md:hidden': isCollapsed}">
                        {{ __('messages.supervisor') }}
                    </h2>
                    <!-- Desktop/tablet collapse toggle -->
                    <button
                        @click="toggleSidebar()"
                        class="sidebar-collapse-button hidden md:inline-flex p-2 hover:bg-gray-100 rounded-lg transition-all duration-300"
    ...
    @include('layouts.supervisor-bottom-nav')
        ...
        function sidebarState() {
            return {
                ...
                toggleSidebar() {
                    ...
                    localStorage.setItem('supervisorSidebarCollapsed', this.isCollapsed);
                },
                ...
                init() {
                    const collapsed = localStorage.getItem('supervisorSidebarCollapsed');
                    if (collapsed !== null) {
