...
<div class="md:hidden" x-data="{ sheet: null, toggle(s) { this.sheet = this.sheet === s ? null : s } }">
         ...
         x-transition:leave-end="translate-y-full">
            <div class="bg-white rounded-2xl shadow-2xl ring-1 ring-black/5 overflow-hidden">
                ...
                <div x-show="sheet === 'tenant'" class="p-2">
                    ...
                    <div class="space-y-1">
                        <a href="{{ route('supervisor.tenants.index') }}" class="bn-sheet-link {{ request()->routeIs('supervisor.tenants.index') ? 'active' : '' }}">
                        ...
                        <a href="{{ route('supervisor.tenants.archived') }}" class="bn-sheet-link {{ request()->routeIs('supervisor.tenants.archived') ? 'active' : '' }}">
                            <span class="bn-sheet-icon">
                ...
                <div x-show="sheet === 'revenue'" class="p-2">
                    ...
                    <div class="space-y-1">
                        <a href="{{ route('supervisor.revenue_expense.index') }}" class="bn-sheet-link {{ request()->routeIs('supervisor.revenue_expense.index') ? 'active' : '' }}">
                            <span class="bn-sheet-icon">
                        ...
                        <a href="{{ route('supervisor.revenue_expense.break_even') }}" class="bn-sheet-link {{ request()->routeIs('supervisor.revenue_expense.break_even') ? 'active' : '' }}">
                            <span class="bn-sheet-icon">
                ...
                <div x-show="sheet === 'more'" class="p-2">
                    ...
                    <div class="space-y-1">
                        <a href="{{ route('supervisor.settings.index') }}" class="bn-sheet-link {{ request()->routeIs('supervisor.settings.*') ? 'active' : '' }}">
                            <span class="bn-sheet-icon">
    ...
    <nav class="bn-bar fixed bottom-0 inset-x-0 z-[58] flex items-stretch bg-white border-t border-gray-200">
        {{-- Home --}}
        <a href="{{ route('supervisor.dashboard') }}" class="bn-item {{ $isHome ? 'active' : '' }}">
            <span class="bn-icon">
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7m-9 2v8m4-8v8m5-12l2 2m-2-2v12a1 1 0 01-1 1h-4m-6 0H4a1 1 0 01-1-1V10m0 0l2-2"/></svg>
            </span>
