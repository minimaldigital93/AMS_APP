<nav class="space-y-1">
    ...
    <a href="{{ route('tenant.payments.index') }}"
       class="nav-link flex items-center gap-3 rounded-lg px-3 py-3 text-sm font-medium transition-all duration-200 {{ request()->routeIs('tenant.payments.*') ? 'text-indigo-700 active' : 'text-gray-700 hover:text-indigo-700' }}">
        <span class="nav-icon sidebar-transition">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <a href="{{ route('tenant.settings') }}"
       class="nav-link flex items-center gap-3 rounded-lg px-3 py-3 text-sm font-medium transition-all duration-200 {{ request()->routeIs('tenant.settings') ? 'text-indigo-700 active' : 'text-gray-700 hover:text-indigo-700' }}">
        <span class="nav-icon sidebar-transition">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <span class="nav-text truncate sidebar-label">{{ __('messages.settings') }}</span>
    </a>
</nav>
