<nav class="space-y-1" x-data="{ expandedSections: { 'Property': false, 'Tenant': false, 'Revenue': false, 'Settings': false } }">
    <style>
        ...
        .nav-link:hover .nav-icon {
            ...
            background: linear-gradient(135deg, rgba(16, 185, 129, 0.28) 0%, rgba(5, 150, 105, 0.25) 100%);
            box-shadow: 0 6px 20px rgba(16, 185, 129, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.3);
        }
        ...
        .nav-link.active {
            ...
            color: #059669;
            font-weight: 600;
            box-shadow: inset 0 0 0 2px rgba(16, 185, 129, 0.35), 0 4px 12px rgba(16, 185, 129, 0.15);
            position: relative;
        }
        ...
        .nav-link.active .nav-icon {
            ...
            box-shadow: 0 8px 24px rgba(16, 185, 129, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.4);
        }
        ...
        .section-header::before {
            ...
            height: 100%;
            width: 3px;
            background: linear-gradient(to bottom, #10b981, #059669, #34d399);
            opacity: 0;
    ...
    <div class="mt-4">
        ...
        <div x-show="expandedSections['Revenue']"
            ...
            {{-- Dashboard --}}
            <a href="{{ route('supervisor.revenue_expense.index') }}" class="submenu-item nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm {{ request()->routeIs('supervisor.revenue_expense.index') ? 'text-emerald-700 active' : 'text-gray-700 hover:text-emerald-700' }} transition-all sidebar-transition">
                <span class="nav-icon sidebar-transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7m-9 2v8m4-8v8m5-12l2 2m-2-2v12a1 1 0 01-1 1h-4m-6 0H4a1 1 0 01-1-1V10m0 0l2-2" />
                    </svg>
            ...
            {{-- Record Expense --}}
            <a href="{{ route('supervisor.revenue_expense.record_expense') }}" class="submenu-item nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm {{ request()->routeIs('supervisor.revenue_expense.record_expense') ? 'text-emerald-700 active' : 'text-gray-700 hover:text-emerald-700' }} transition-all sidebar-transition">
                <span class="nav-icon sidebar-transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {{-- Calendar View --}}
            <a href="{{ route('supervisor.revenue_expense.monthly_calendar') }}" class="submenu-item nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm {{ request()->routeIs('supervisor.revenue_expense.monthly_calendar') ? 'text-emerald-700 active' : 'text-gray-700 hover:text-emerald-700' }} transition-all sidebar-transition">
                <span class="nav-icon sidebar-transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {{-- Break-even Analysis --}}
            <a href="{{ route('supervisor.revenue_expense.break_even') }}" class="submenu-item nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm {{ request()->routeIs('supervisor.revenue_expense.break_even') ? 'text-emerald-700 active' : 'text-gray-700 hover:text-emerald-700' }} transition-all sidebar-transition">
                <span class="nav-icon sidebar-transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="mt-4">
        <a href="{{ route('supervisor.settings.index') }}"
           class="section-header flex items-center justify-between w-full transition sidebar-transition {{ request()->routeIs('supervisor.settings.*') ? 'text-emerald-700' : '' }}">
            <span class="flex items-center gap-2.5">
                <span class="section-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
