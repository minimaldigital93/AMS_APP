            ...
            <div class="bg-white rounded-2xl shadow-2xl ring-1 ring-black/5 overflow-hidden">
                ...
                <div x-show="sheet === 'revenue'" class="p-2">
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ route('admin.revenue_expense.pending_payments') }}" class="bn-sheet-link {{ request()->routeIs('admin.revenue_expense.pending_payments') ? 'active' : '' }}">
                            <span class="bn-sheet-icon">
                ...
                <div x-show="sheet === 'more'" class="p-2">
                    ...
                    <div class="space-y-1">
                        ...
                        {{-- Billing & Subscription is a row INSIDE System Settings
                             now, so this sheet offers one way in rather than two.
                             It still lights on admin.billing.*, because that is
                             where this link's page leads. --}}
                        <a href="{{ route('admin.settings.index') }}" class="bn-sheet-link {{ request()->routeIs('admin.settings.*', 'admin.billing.*') ? 'active' : '' }}">
                            <span class="bn-sheet-icon">
